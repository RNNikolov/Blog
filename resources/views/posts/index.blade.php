    ...
    <div class="col-md-12">
        <div class="jumbotron" style="background-image: url(https://images.unsplash.com/photo-1549421263-5ec394a5ad4c?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80); background-repeat: no-repeat; background-size: cover; background-position: center">
            <div class="row align-items-center justify-content-center">
                <h1 class="display-2 text-light" style="font-family: Montserrat">My posts</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right rounded flex-auto d-none d-md-block" alt="Responsive image" style="width: 200px; height: 250px" src="{{ $post->image->url }}">
            </div>
        </div>
        @endforeach
    </div>
